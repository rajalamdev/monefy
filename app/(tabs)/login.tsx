    ...
    return (
        <ThemedView className="py-8 px-6 justify-center flex-1 items-center">
            ...
            <View className="flex-row gap-2 mb-8">
                <ThemedText type="title">Login to</ThemedText>
            ...
            <ThemedView className="flex-row gap-2">
                <ThemedText className={`${currentColor === "dark" ? "text-[#A6A6A6]" : "text-[#666]"}`}>Dont have an account?</ThemedText>
                <TouchableOpacity onPress={() => router.navigate("register")}>
                    <ThemedText className="border-b border-green-400">Register</ThemedText>
                </TouchableOpacity>
            </ThemedView>
            <TouchableOpacity onPress={() => router.replace("home")} className="bg-green-400 w-full py-3 rounded-lg mt-4">
                <ThemedText className="text-center text-black font-medium">Login</ThemedText>
            </TouchableOpacity>
        </ThemedView>
    )
}